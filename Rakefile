# Rakefile by Stan Chang Khin Boon (@lxcid) for AFNetworking.
...
task :test do
  verbose = ENV['VERBOSE']
  ios = test_project('Code Stream.xcodeproj', 'Code Stream Tests', '-configuration Debug -sdk iphonesimulator RUN_UNIT_TEST_WITH_IOS_SIM=YES', verbose)
